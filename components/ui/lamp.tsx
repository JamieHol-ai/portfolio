...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-[60vh] flex-col items-center justify-center overflow-hidden bg-black-100 w-full rounded-md z-0",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        >
          ...
          <div className="absolute  w-40 h-[0%] left-0 bg-black-100  bottom-0 z-20 [mask-image:linear-gradient(to_right,white,transparent)]" />
        </motion.div>
        <motion.div
          initial={{ opacity: 0.5, width: "15rem" }}
          whileInView={{ opacity: 1, width: "30rem" }}
        ...
        <div className="absolute top-1/4 h-48 w-full translate-y-12 scale-x-150 bg-black-100 blur-2xl"></div>
      ...
      <div className="relative z-50 flex bottom-20 flex-col items-center px-5">
        {children}
      </div>
    </div>
  );
